...
def distance_calculator(start, end_list):
    ...
    for end_spot in end_list:
        distance = (  (end_spot[0] - start[0])**2 + (end_spot[1] - start[1])**2 )**0.5
...
def slope_dictionary_maker(laser_location, asteroid_layout_list, quadrant):
    ...
    for asteroid in asteroid_layout_list:
        if asteroid[1] == laser_location[1]:
            ...
            slope = (asteroid[0] - laser_location[0]) / (asteroid[1] - laser_location[1])
...
def zap_q1(laser_location, asteroid_layout_q1, asteroids_zapped):
    ...
    asteroid_dict_q1 = slope_dictionary_maker(laser_location, asteroid_layout_q1, 1)
...
def zap_q2(laser_location, asteroid_layout_q2, asteroids_zapped):
    ...
    asteroid_dict_q2 = slope_dictionary_maker(laser_location, asteroid_layout_q2, 2)
...
def zap_q3(laser_location, asteroid_layout_q3, asteroids_zapped):
    ...
    asteroid_dict_q3 = slope_dictionary_maker(laser_location, asteroid_layout_q3, 3)
...
def zap_q4(laser_location, asteroid_layout_q4, asteroids_zapped):
    ...
    asteroid_dict_q4 = slope_dictionary_maker(laser_location, asteroid_layout_q4, 4)
...
asteroid_layout_q1 = [asteroid for asteroid in asteroid_layout if asteroid[0] >= laser_location[0] and asteroid[1] < laser_location[1]]
asteroid_layout_q2 = [asteroid for asteroid in asteroid_layout if asteroid[0] > laser_location[0] and asteroid[1] >= laser_location[1]]
asteroid_layout_q3 = [asteroid for asteroid in asteroid_layout if asteroid[0] <= laser_location[0] and asteroid[1] > laser_location[1]]
asteroid_layout_q4 = [asteroid for asteroid in asteroid_layout if asteroid[0] < laser_location[0] and asteroid[1] <= laser_location[1]]
...
while len(asteroids_zapped) < 200:
    asteroids_zapped, asteroid_layout_q1 = zap_q1(laser_location, asteroid_layout_q1, asteroids_zapped)
    asteroids_zapped, asteroid_layout_q2 = zap_q2(laser_location, asteroid_layout_q2, asteroids_zapped)
    asteroids_zapped, asteroid_layout_q3 = zap_q3(laser_location, asteroid_layout_q3, asteroids_zapped)
    asteroids_zapped, asteroid_layout_q4 = zap_q4(laser_location, asteroid_layout_q4, asteroids_zapped)
